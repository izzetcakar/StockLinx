...
namespace StockLinx.Repository.Migrations
{
    ...
    [Migration("20230612133620_updateNullables")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StockLinx.Core.Entities.DeployedProduct", b =>
                {
                    ...
                    b.ToTable("DeployedProduct");
                });

            modelBuilder.Entity("StockLinx.Core.Entities.Image", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("StockLinx.Core.Models.Accessory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("StockLinx.Core.Models.Asset", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("StockLinx.Core.Models.Location", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("StockLinx.Core.Models.Model", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("StockLinx.Core.Models.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<string>("AdminLvl")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("StockLinx.Core.Entities.Category", b =>
                {
                    b.HasOne("StockLinx.Core.Entities.Image", "Image")
                        .WithMany("Categories")
            ...
            modelBuilder.Entity("StockLinx.Core.Entities.Component", b =>
                {
                    ...
                    b.HasOne("StockLinx.Core.Models.Location", "Location")
                        .WithMany("Components")
            ...
            modelBuilder.Entity("StockLinx.Core.Entities.Department", b =>
                {
                    ...
                    b.HasOne("StockLinx.Core.Models.User", "Manager")
                        .WithMany("Departments")
            ...
            modelBuilder.Entity("StockLinx.Core.Entities.DeployedProduct", b =>
                {
                    b.HasOne("StockLinx.Core.Models.Accessory", "Accessory")
                        .WithMany("DeployedProducts")
                        .HasForeignKey("AccessoryId")
                        .OnDelete(DeleteBehavior.SetNull)
                        .IsRequired();

                    b.HasOne("StockLinx.Core.Models.Asset", "Asset")
                        .WithMany("DeployedProducts")
                    ...
                    b.HasOne("StockLinx.Core.Models.User", "AssignedUser")
                        .WithMany("DeployedProducts")
            ...
            modelBuilder.Entity("StockLinx.Core.Models.Asset", b =>
                {
                    ...
                    b.HasOne("StockLinx.Core.Models.Model", "Model")
                        .WithMany("Assets")
