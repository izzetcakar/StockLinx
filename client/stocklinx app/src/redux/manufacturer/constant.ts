export enum manufacturerConst {
  ...
  FILTER_MANUFACTURERS_REQUEST = "FILTER_MANUFACTURERS_REQUEST",
  FILTER_MANUFACTURERS_SUCCESS = "FILTER_MANUFACTURERS_SUCCESS",
  FILTER_MANUFACTURERS_FAILURE = "FILTER_MANUFACTURERS_FAILURE",
