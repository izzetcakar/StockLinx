export enum manufacturerConst {
  ...
  FETCH_MANUFACTURERS_PAGED_REQUEST = "FETCH_MANUFACTURERS_PAGED_REQUEST",
  FETCH_MANUFACTURERS_PAGED_SUCCESS = "FETCH_MANUFACTURERS_PAGED_SUCCESS",
  FETCH_MANUFACTURERS_PAGED_FAILURE = "FETCH_MANUFACTURERS_PAGED_FAILURE",
  ...
  FETCH_MANUFACTURER_COUNTS_REQUEST = "FETCH_MANUFACTURER_COUNTS_REQUEST",
  FETCH_MANUFACTURER_COUNTS_SUCCESS = "FETCH_MANUFACTURER_COUNTS_SUCCESS",
  FETCH_MANUFACTURER_COUNTS_FAILURE = "FETCH_MANUFACTURER_COUNTS_FAILURE",
  ...
  CREATE_RANGE_MANUFACTURER_REQUEST = "CREATE_RANGE_MANUFACTURER_REQUEST",
  CREATE_RANGE_MANUFACTURER_SUCCESS = "CREATE_RANGE_MANUFACTURER_SUCCESS",
  CREATE_RANGE_MANUFACTURER_FAILURE = "CREATE_RANGE_MANUFACTURER_FAILURE",
  ...
  REMOVE_RANGE_MANUFACTURER_REQUEST = "REMOVE_RANGE_MANUFACTURER_REQUEST",
  REMOVE_RANGE_MANUFACTURER_SUCCESS = "REMOVE_RANGE_MANUFACTURER_SUCCESS",
  REMOVE_RANGE_MANUFACTURER_FAILURE = "REMOVE_RANGE_MANUFACTURER_FAILURE",
