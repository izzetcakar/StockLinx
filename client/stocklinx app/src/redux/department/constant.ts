export enum departmentConst {
  ...
  FILTER_DEPARTMENTS_REQUEST = "FILTER_DEPARTMENTS_REQUEST",
  FILTER_DEPARTMENTS_SUCCESS = "FILTER_DEPARTMENTS_SUCCESS",
  FILTER_DEPARTMENTS_FAILURE = "FILTER_DEPARTMENTS_FAILURE",
